...
var require_defaults = __commonJS((exports, module) => {
  module.exports = {
    host: "localhost",
    user: process.platform === "win32" ? process.env.USERNAME : "iury",
    database: undefined,
    password: null,
...
// src/bunServer.ts
var ConverMethod;
(function(ConverMethod2) {
  ConverMethod2["GET"] = "get";
  ConverMethod2["POST"] = "post";
  ConverMethod2["PUT"] = "put";
})(ConverMethod || (ConverMethod = {}));
...
class BunServe {
  ...
  handleRequest(method, callback) {
    const methodHandlers = {
      [ConverMethod.GET]: (callback2) => callback2(),
      [ConverMethod.POST]: (callback2) => callback2(),
      [ConverMethod.PUT]: (callback2) => callback2()
    };
...
// src/infra/database/PgConnectionAdapter.ts
...
// src/index.ts
var bunInstance = BunServe.getInstance;
var connection = new PgConnectionAdapter;
var responseHandler = {
    ...
    return bunInstance.put(async () => {
      try {
        ...
        if (result.rows && result.rows.length > 0) {
          ...
          throw new Error(`Sistema com ID ${body.id} n\xE3o encontrado`);
        }
      } catch (error) {
...
var server = Bun.serve({
  ...
  async fetch(request) {
    ...
    if (url.pathname === "/systems") {
      return responseHandler[method](request);
    } else {
